...
<body class="{{ $iThemes }} bg-apae-back-light dark:!bg-apae-gray dark:!text-apae-light">

    <x-admin.default.sidebar logoPath="{{ $logoPath }}" />

    <main
        class="apae-content ml-[200px] h-[100vh] overflow-auto bg-apae-dark/10 dark:bg-apae-gray dark:text-apae-light">
